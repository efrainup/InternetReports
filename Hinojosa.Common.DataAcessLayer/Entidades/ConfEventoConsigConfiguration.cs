...
namespace Hinojosa.Common.DataAccessLayer.Entidades
{
    ...
    public class ConfEventoConsigConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConfEventoConsig>
    {
        public ConfEventoConsigConfiguration()
            : this("dbo")
        {
        }

        public ConfEventoConsigConfiguration(string schema)
        {
            ToTable("Conf_Evento_consig", schema);
            HasKey(x => new { x.Id, x.Descripcion, x.Status });
            ...
            Property(x => x.IdNodo).HasColumnName(@"IdNodo").HasColumnType("int").IsOptional();
            Property(x => x.IdPadre).HasColumnName(@"IdPadre").HasColumnType("int").IsOptional();
            Property(x => x.Idgpo).HasColumnName(@"Idgpo").HasColumnType("int").IsOptional();
