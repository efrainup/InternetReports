...
namespace Hinojosa.Common.DataAccessLayer.Entidades
{
    ...
    public class ConfAlmacConsigConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConfAlmacConsig>
    {
        public ConfAlmacConsigConfiguration()
            : this("dbo")
        {
        }

        public ConfAlmacConsigConfiguration(string schema)
        {
            ToTable("Conf_almac_consig", schema);
