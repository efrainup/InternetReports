...
namespace Hinojosa.Common.DataAccessLayer.Entidades
{
    ...
    public class CxpAuxConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CxpAux>
    {
        public CxpAuxConfiguration()
            : this("dbo")
        {
        }

        public CxpAuxConfiguration(string schema)
        {
            ToTable("cxp_aux", schema);
            HasKey(x => x.IdCxpAux);

            Property(x => x.IdCxpAux).HasColumnName(@"id_cxp_aux").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            ...
            Property(x => x.CSelPag).HasColumnName(@"c_sel_pag").HasColumnType("tinyint").IsRequired();
            Property(x => x.MtoSelApl).HasColumnName(@"mto_sel_apl").HasColumnType("float").IsRequired();
            Property(x => x.IdSisCnl).HasColumnName(@"id_sis_cnl").HasColumnType("int").IsRequired();
            Property(x => x.FecPrgPag).HasColumnName(@"fec_prg_pag").HasColumnType("datetime").IsRequired();
            ...
            // Foreign keys
            HasRequired(a => a.CatUsr).WithMany(b => b.CxpAuxes).HasForeignKey(c => c.IdUsr).WillCascadeOnDelete(false); // FK_cxp_aux_cat_usr
        }
    }
