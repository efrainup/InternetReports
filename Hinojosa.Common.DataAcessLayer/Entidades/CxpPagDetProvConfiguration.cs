...
namespace Hinojosa.Common.DataAccessLayer.Entidades
{
    ...
    public class CxpPagDetProvConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CxpPagDetProv>
    {
        public CxpPagDetProvConfiguration()
            : this("dbo")
        {
        }

        public CxpPagDetProvConfiguration(string schema)
        {
            ToTable("cxp_pag_det_prov", schema);
            HasKey(x => new { x.Uuid, x.IdPago, x.IdPagDet, x.UuidDr, x.FolioDr, x.MdaDr, x.TcDr, x.MetPagDr, x.NumParcDr, x.ImpSadoAntDr, x.ImpPagDr, x.ImpSdoInsDr, x.Cve, x.Cant, x.Udm, x.Des, x.@Base, x.Impto, x.TipFactor, x.Tasaocuota, x.TotalImpto, x.Status, x.IdRelPagCrp, x.SaldoPendiente });
            ...
            Property(x => x.Impto).HasColumnName(@"impto").HasColumnType("float").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TipFactor).HasColumnName(@"tip_factor").HasColumnType("float").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
