...
namespace Hinojosa.Common.DataAccessLayer.Entidades
{
    ...
    public class BcoIvaDetConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BcoIvaDet>
    {
        public BcoIvaDetConfiguration()
            : this("dbo")
        {
        }

        public BcoIvaDetConfiguration(string schema)
        {
            ToTable("bco_iva_det", schema);
