...
namespace Hinojosa.Common.DataAccessLayer.Entidades
{
    ...
    public class CxpPagEncAuxProvConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CxpPagEncAuxProv>
    {
        public CxpPagEncAuxProvConfiguration()
            : this("dbo")
        {
        }

        public CxpPagEncAuxProvConfiguration(string schema)
        {
            ToTable("cxp_pag_enc_aux_prov", schema);
            HasKey(x => x.IdPagAux);

            Property(x => x.IdPagAux).HasColumnName(@"id_pag_aux").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            ...
            Property(x => x.IdProFis).HasColumnName(@"id_pro_fis").HasColumnType("int").IsRequired();
            Property(x => x.StatusConcil).HasColumnName(@"status_concil").HasColumnType("tinyint").IsRequired();
            Property(x => x.MailEnv).HasColumnName(@"mail_env").HasColumnType("bit").IsRequired();
        }
    }
