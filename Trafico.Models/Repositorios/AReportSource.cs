...
namespace Hinojosa.RECOVFP.DataAccessLayer.Repositorios
{
    public abstract class AReportSource<T>
    {
        ...
        protected  DatabaseProviderFactory DbProvider
        {
            get
            {
                _dbFactory = _dbFactory ?? new DatabaseProviderFactory();
                return _dbFactory;
            }
        }
        ...
        public static IEnumerable<U> Fill<U>(DbDataReader reader)
        {
            List<U> enumerable = new List<U>();
