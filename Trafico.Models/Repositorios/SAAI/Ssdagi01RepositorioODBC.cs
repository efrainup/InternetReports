...
{
    public class Ssdagi01RepositorioODBC : AReportSource<Ssdagi01Entity>, ISsdagi01, IDisposable
    {
        Database database;

        public Ssdagi01RepositorioODBC(string nombreConfiguracion = "DBFS_SAAI_DATASOURCE")
        {
        ...
        public List<Ssdagi01Entity> RecuperarPorPedimentoAñoAduana(string pedimento, int año, int aduana)
        {
        ...
        {
            comando.CommandText = "SELECT * FROM Ssdagi01 WHERE Numped01=? AND Fecpag01 BETWEEN ? AND ? ";
        ...
        public async Task<List<Ssdagi01Entity>> RecuperarPorPedimentoAñoAduanaAsync(string pedimento, int año, int aduana)
        {
            DateTime fechaInicio = Convert.ToDateTime($"01/01/{año}");
            DateTime fechaFin = Convert.ToDateTime($"31/12/{año}");
        ...
        public List<Ssdagi01Entity> RecuperarPorReferencia(string referencia)
        {
        ...
        {
            comando.CommandText = "SELECT * FROM Ssdagi01 WHERE Refcia01=?";
        ...
        public async Task<List<Ssdagi01Entity>> RecuperarPorReferenciaAsync(string referencia)
        {
            using (DbConnection conexion = database.CreateConnection())
            {
                await conexion.OpenAsync();
